...
def main(page: ft.Page):
    ...
    harim_bottom_tip_sheet = ft.BottomSheet(
        barrier_color=ft.Colors.TRANSPARENT,  # 뒤 배경 안 까맣게
        ...
        content=ft.Container(
            ...
            content=ft.Column(
                tight=True,
                controls=[
                    ft.Text("오늘의 기록: 2026.03.19  ", size=25, weight="bold"),
                    ft.Container(height=10),
                    white_long_box3("물 10ml를 마셨습니다", "오전 07:30"),
                    white_long_box3("물 10ml를 마셨습니다", "오전 07:30"),
                    white_long_box3("물 10ml를 마셨습니다", "오전 07:30"),
                    white_long_box3("사료 35g을 먹었습니다", "오전 07:00"),
                    ft.Container(height=10),
                    ft.Container(
                        height=50,
                        bgcolor=ft.Colors.WHITE,
